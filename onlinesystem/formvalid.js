...
function firstfocus()
{
var uid = document.registration.First_Name.focus();
return true;
}

// This function will validate first name.
function First_Name_validation(mx,my)
{
...
function Last_Name_validation(mx,my)
{
var uid = document.registration.Last_Name;
var uid_len = uid.value.length;
if (uid_len == 0 || uid_len >= my || uid_len < mx)
{
alert("User Id should not be empty / length be between "+mx+" to "+my);
